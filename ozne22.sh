#!/bin/bash
# ozne22 v2.0
# recoded by: Termux ozne
# github.com/anonymouseh/izne1
...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   criado por - \e[1;92m Ozne"
...
printf "\n"
data='{"phone_id":"'$phone'", "_csrftoken":"'$var2'", "usuário":"'$user'", "guid":"'$guid'", "device_id":"'$device'", "senha":"'$pass'", "login_attempt_count":"0"}'
...
printf "  \e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Tentando logar como\e[0m\e[1;93m %s\e[0m\n" $user
IFS=$'\n'
...
printf "\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Está técnica consiste em seguir/para de seguir famosos\e[0m\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Pode aumentar seus seguidores até cerca de +30 em 1 hora \e[0m\n"
...
larissamanoela="1665466078"
gusttavolima="22079794"


if  ! -e celeb_id ; then
printf " %s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $dualipa $celebrity $mileycyrus $shawnmendes $katyperry $charlieputh $lelepons $camila_cabello $madonna $leonardodicaprio $ladygaga $taylorswift $instagram $neymar $selena $ariana $beyonce $professor $cristiano $kimkardashian $kendall $therock $kylie $jelopez $messi $gusttavolima $larissamanoela $tatawerneck> celeb_id
fi
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Seguindo famoso %s ..." $celeb
...
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m espere 40 segundos...\e[0m\n"
sleep 40
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Deixando de seguir famoso %s ..." $celeb
...
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Espere 40 segundos para prevenção de bloqueio...\e[0m\n"
sleep 40
